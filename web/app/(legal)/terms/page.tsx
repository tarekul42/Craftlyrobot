...
export const metadata: Metadata = {
  ...
  description: "The terms that govern your use of Craftly's website and products.",
  ...
  return (
    <Prose>
      ...
      <ul>
        ...
        <li>Not use automated systems to access the Services in a way that sends more requests than a human reasonably could</li>
      ...
      <p>
        ...
        owned by Craftly and are protected by international copyright, trademark,
      ...
      <p>
        ...
        or any loss of profits or revenues, arising from your use of the Services.
      </p>
